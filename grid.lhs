...
(N, S, E, W)
	...
	the getneighbors() function for each region
...
(n-4,n+4,n-1     ,n+1)
	...
	the maximum amount of cells we can assign randomly are (1,3,7,11,17,24,33...) a sequence also known as A331968.
